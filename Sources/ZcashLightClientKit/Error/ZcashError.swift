...
public enum ZcashError: Equatable, Error {
    ...
    /// - `rustError` contains error generated by the rust layer.
    /// ZRUST0150
    case rustGetStoredTransaction(_ rustError: String)
    ...
    /// wallet database when preparing it for submission — neither `v_transactions` nor the backend's
    /// own transaction store returned it.
    /// - `txId` contains the hex-encoded transaction id of the missing transaction.
    /// ZTREE0007
    case transactionRepositoryCreatedTransactionNotFound(_ txId: String)
    ...
    public var message: String {
        ...
        case .rustGetStoredTransaction: return "Error from rust layer when calling ZcashRustBackend.getStoredTransaction"
        ...
        case .transactionRepositoryCreatedTransactionNotFound: return "A transaction the rust layer reported as created and stored could not be read back from the"
    ...
    public var code: ZcashErrorCode {
        ...
        case .rustGetStoredTransaction: return .rustGetStoredTransaction
        ...
        case .transactionRepositoryCreatedTransactionNotFound: return .transactionRepositoryCreatedTransactionNotFound
