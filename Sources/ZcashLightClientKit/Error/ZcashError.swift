...
public enum ZcashError: Equatable, Error {
    ...
    /// - `rustError` contains error generated by the rust layer.
    /// ZRUST0093
    case rustPlanOrchardDenominationSplit(_ rustError: String)
    ...
    public var message: String {
        ...
        case .rustPlanOrchardDenominationSplit: return "Error from rust layer when calling ZcashRustBackend.planOrchardDenominationSplit"
    ...
    public var code: ZcashErrorCode {
        ...
        case .rustPlanOrchardDenominationSplit: return .rustPlanOrchardDenominationSplit
