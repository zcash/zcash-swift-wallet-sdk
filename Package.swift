...
if useLocalFFI {
    ...
    targets.append(
        .binaryTarget(
            name: "libzcashlc",
            url: "https://github.com/zcash/zcash-swift-wallet-sdk/releases/download/2.7.0-rc.4/libzcashlc.xcframework.zip",
            checksum: "c012c2b682191f027c1874ecde84adeeaef26dbb3e827dd5f29deb0eb8af0ef2"
        )
    )
