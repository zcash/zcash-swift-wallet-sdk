...
if useLocalFFI {
    ...
    targets.append(
        .binaryTarget(
            name: "libzcashlc",
            url: "https://github.com/valargroup/zcash-swift-wallet-sdk/releases/download/0.11.0-voting/libzcashlc.xcframework.zip",
            checksum: "f005586e200b8f8fec8637f1bbf834e2463856ddec33e1359857258b4e95d622"
        )
    )
