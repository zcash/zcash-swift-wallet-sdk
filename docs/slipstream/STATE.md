...
➡️ **T1.4** — verify + fetch (continuity check, K parallel claim-workers, ordered emission). Detailed steps: docs/slipstream/plans/2026-06-10-phase-1-transport.md, Task 1.4.
