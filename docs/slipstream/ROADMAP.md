...
| P6 | Sparse tree persistence (T6.1–T6.6 DONE; T6.7 device pending) | Golden-oracle harness; checkpoint-downgrade spike (T6.3b GO: 5.05×); oracle-clean (T6.4: hermetic+darkside+mainnet IDENTICAL); reorg+truncate (T6.5: darkside 9/9 green); default-ON (T6.6: Mac 5.27×, OfflineTests 463/0, XCFramework rebuilt) | **G6:** device field run pending (T6.7 [needs-user]). Mac MEASURED: 5.27× (scan_s 39.47→7.49s, 50k blk, 2026-06-11). Device bets: iPhone 16 Pro 269k blk <73s (bet ~37–55s); iPad A10 269k blk <533s (bet ~190–380s). |
